...
document.getElementById('finishGameBtn').addEventListener('click', ()=>{
  ...
  // у четырёх игр (Виселица, Лимонадный ларёк, Пройди квест, Карта страсти).
...
(function(){
  ...
  // Обновление: во время активной сессии и при возврате из фона Service
  // Worker проверяет новую версию и показывает плашку #updateToast с кнопкой
  // «Обновить» и крестиком (см. блок регистрации в index.html) —
  // принудительное обновление по-прежнему доступно через hardUpdateApp().
