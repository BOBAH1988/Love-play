 ...
 * и закреплён дефолт «случайный порядок» (запрос владельца, 2026-09-24):
...
function performFullReset(){
  ...
  if(typeof wrRenderSetupGameMode === 'function') wrRenderSetupGameMode();
...
// владельца, 2026-09-24). Указатель порядка хранится отдельно для каждого
...
function updatePhotoRandomToggleBtn(){
  ...
  // Иконки и подсказки переставлены местами по запросу владельца (2026-09-24):
