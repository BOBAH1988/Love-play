...
let state = {
  ...
  gameType:'fanty',
  /* Рулетка желаний */
  wrSelectedLevel:1, wrScore1:0, wrScore2:0, wrGameMode:'simple', /* 'fanty' — случайный тип карты; 'td' — игрок выбирает Правду/Действие перед ходом */
